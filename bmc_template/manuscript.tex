...
\section*{Results}
  ...
  \caption{\csentence{Frequency of choosing BIC-optimal state on simulated data.} 45 out of 100 sets of simulated data from a 2-state HMM with BIC-optimal state frequency for 2-6 state HMMs with and without covariate transition on 100 two-state hidden Markov models with covariate transitioning simulations.}
      \end{figure}
