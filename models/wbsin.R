...
rModels[[7]] <- list()
rModels[[7]][[1]] <- weibull(dist, pstart = c(6,2),data=dat)
...
fitlist <- list(wbsinhmm3s,wbsinhmm4s,wbsinhmm5s,wbsinhmm6s,wbsinhmm7s)

catsum <- sumdf(fitlist)


saveRDS(catsum,file=paste("cat",catid,"wbsinhmm","RDS",sep="."))
