...
weibull3s <- fit(w3, verbose = TRUE, emc=em.control(rand=FALSE, maxit=460))
...
w4 <- makeDepmix(response = rModels, transition = transition,
                   prior=inMod,homogeneous = FALSE)
weibull4s <- fit(w4, verbose = TRUE, emc=em.control(rand=FALSE, maxit=460))
summary(weibull4s)
...
w5 <- makeDepmix(response = rModels, transition = transition,
                   prior=inMod,homogeneous = FALSE)
weibull5s <- fit(w5, verbose = TRUE, emc=em.control(rand=FALSE, maxit=460))
summary(weibull5s)
...
w6 <- makeDepmix(response = rModels, transition = transition,
                   prior=inMod,homogeneous = FALSE)
weibull6s <- fit(w6, verbose = TRUE, emc=em.control(rand=FALSE, maxit=460))
summary(weibull6s)
...
w7 <- makeDepmix(response = rModels, transition = transition,
                 prior=inMod,homogeneous = FALSE)
weibull7s <- fit(w7, verbose = TRUE, emc=em.control(rand=FALSE, maxit=460))
summary(weibull7s)
