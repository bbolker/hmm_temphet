...
approximately constant. Changes in behavioural mode transition 
...
models ranging from 2 to 6 latent behavioural modes.
\todo{not sure about terminology here (should be consistent about
what we call the modes/latent states/whatever) ML: What do you think? Are ecologist more comfortable with modes/ latent states?}
