...
conditions \citep{fryxell_multiple_2008}.\cite{schliehe-diecks_application_2012}
...
where the occupancy probabilities changed deterministically over time.  Thus FMMs and HMMs,
