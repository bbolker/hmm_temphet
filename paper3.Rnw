...
\citep{fryxell_multiple_2008}. On the other side of the 
...
good for estimation of number of states \citep{biernacki2000assessing}, 
...
these can both test overall goodness-of-fit \citep{potts_generalized_2014} 
