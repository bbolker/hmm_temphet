...
<<state_plots cat2, warning=FALSE, message=FALSE, echo=FALSE>>=
...
<<state_plots cat14, warning=FALSE, message=FALSE, echo=FALSE>>=
...
<<state_plots cat15, warning=FALSE, message=FALSE, echo=FALSE, fig.cap="State Parameter Estimates">>=
